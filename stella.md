...
description: стелла отдельно стоящая рекламная конструкция. Используется для идентификации автосалонов, торговых центров, АЗС. Размещаются вдоль автомагистралей или на внутренних территориях.
